...
namespace DataVault.UI.Utils.CustomMessageBoxes.Impl
{
	...
	internal class MessageBoxExForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.MessageBoxExForm_KeyDown);
        ...
        private void MessageBoxExForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Escape && !e.Control && !e.Alt && !e.Shift)
            {
...
//					break;
		...
		private void SetOptimumSize()
		{
		    ...
		    requiredHeight -= 20; // note. added by me, xeno.by
