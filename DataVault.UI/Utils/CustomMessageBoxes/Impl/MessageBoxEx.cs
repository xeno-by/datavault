...
namespace DataVault.UI.Utils.CustomMessageBoxes.Impl
{
	...
	internal class MessageBoxEx
	{
	    ...
	    {
            get { return _msgBox.DefaultButtonIndex; }
            set { _msgBox.DefaultButtonIndex = value; }
        }

        internal ReadOnlyCollection<MessageBoxExButton> Buttons
        {
            get { return _msgBox.Buttons.Cast<MessageBoxExButton>().ReadOnly(); }
        }
