...
namespace DataVault.UI.Utils.CustomMessageBoxes.Impl
{
	/// <summary>
    ...
    internal class MessageBoxExManager
	{
        ...
        static MessageBoxExManager()
        {
            try
            {
                ...
                _standardButtonsText[MessageBoxExButtons.Ok.ToString()] = Resources.CustomMessageBox_Ok;
                _standardButtonsText[MessageBoxExButtons.Cancel.ToString()] = Resources.CustomMessageBox_Cancel;
                _standardButtonsText[MessageBoxExButtons.Yes.ToString()] = Resources.CustomMessageBox_Yes;
                _standardButtonsText[MessageBoxExButtons.No.ToString()] = Resources.CustomMessageBox_No;
                _standardButtonsText[MessageBoxExButtons.Abort.ToString()] = Resources.CustomMessageBox_Abort;
                _standardButtonsText[MessageBoxExButtons.Retry.ToString()] = Resources.CustomMessageBox_Retry;
                _standardButtonsText[MessageBoxExButtons.Ignore.ToString()] = Resources.CustomMessageBox_Ignore;
            }
            catch(Exception ex)
            {
