...
namespace DataVault.UI.Impl.Controls.FileSystem.ShellAPI
{
    ...
    /// </summary>
    internal static class NativeShellAPI
    {
        ...
        public static extern bool GetMenuItemInfo(
            ...
            uint uItem,
            bool fByPos,
            ref NativeShellAPI.MENUITEMINFO lpmii);
        ...
        public struct STATSTG
        {
            ...
            public STGTY type;
            public long cbSize;
            public NativeShellAPI.FILETIME mtime;
            public NativeShellAPI.FILETIME ctime;
            public NativeShellAPI.FILETIME atime;
            public STGM grfMode;
        ...
        public static DateTime FileTimeToDateTime(NativeShellAPI.FILETIME fileTime)
        {
