...
{
    internal sealed class ShellItem : IEnumerable, IDisposable, IComparable
    {
        #region Fields

        private ShellBrowserComponent browser;
        ...
        internal ShellBrowserComponent Browser { get { return browser; } }
    ...
    internal class ShellItemEnumerator : IEnumerator
    {
