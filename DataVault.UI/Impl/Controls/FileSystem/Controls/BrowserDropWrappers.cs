...
namespace DataVault.UI.Impl.Controls.FileSystem.Controls
{
    ...
    /// </summary>
    internal class BrowserTVDropWrapper : ShellAPI.Interfaces.IDropTarget, IDisposable
    {
        #region Fields
        ...
        private ShellAPI.Interfaces.IDropTarget dropTarget;
        ...
        private NativeShellAPI.MK mouseButtons;
        ...
        public int DragDrop(IntPtr pDataObj, NativeShellAPI.MK grfKeyState, NativeShellAPI.POINT pt, ref DragDropEffects pdwEffect)
        {
            OnDrop(new DropEventArgs(mouseButtons, br.FolderView));

            if (!((mouseButtons & NativeShellAPI.MK.RBUTTON) != 0 ||
                  grfKeyState == NativeShellAPI.MK.CONTROL ||
                  grfKeyState == NativeShellAPI.MK.ALT ||
                  grfKeyState == (NativeShellAPI.MK.CONTROL | NativeShellAPI.MK.SHIFT)) && ShellItem.Equals(parentDragItem, parentDropItem))
            {
                ResetDrop();
                ReleaseCom();
                pdwEffect = DragDropEffects.None;
    ...
    /// </summary>
    internal class BrowserLVDropWrapper : ShellAPI.Interfaces.IDropTarget, IDisposable
    {
        #region Fields
    ...
    internal class DropEventArgs : EventArgs
    {
        ...
        public DropEventArgs(NativeShellAPI.MK mouseButtons, Control dragStartControl)
        {
            this.mouseButtons = mouseButtons;
            this.dragStartControl = dragStartControl;
        }

        public NativeShellAPI.MK MouseButtons { get { return mouseButtons; } }
